...
Os materiais do experimento, os enunciados das atividades, os instrumentos e os scripts de análise estatística serão disponibilizados em repositório público no GitHub. Endereço a inserir quando o repositório for publicado: \texttt{URL\_REPOSITORIO\_GITHUB}.
