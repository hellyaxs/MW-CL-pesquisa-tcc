...
% Grau a ser obtido → "obtenção do título de Bacharelado em Engenharia da Computação"
...
% Título do trabalho (não confundir com o grau acima)
...
\coorientador{Prof. Dr. Waldemar Neto} % Para coorientadora, usar opção abaixo
%\coorientador[Coorientadora:]{Profa. Nome completo da coorientadora}


% Dados da banca
\nomePrimeiromembro{Prof. Dr. Denini Gabriel (Examinador Interno)}
\instPrimeiromembro{Universidade Federal Rural de Pernambuco}
 
\nomeSegundomembro{Prof. Dr. Anderson Pinheiro (Examinador Interno)}
\instSegundomembro{Universidade Federal Rural de Pernambuco}
...
\begin{document}
    ...
    \include{Textos/pre-textuais/lista-simbolos}
    \tableofcontents*
    \newpage
...
\end{document}overleaf_session2=s%3AbFNJCkhJ2r1yPcrnMnQI-kMcXVh8dwIY.yQKGuJIzXUiVte0ejpwjDnfXmmWof0W%2FZct3n4QEBwY
\end{document}overleaf_session2=s%3AbFNJCkhJ2r1yPcrnMnQI-kMcXVh8dwIY.yQKGuJIzXUiVte0ejpwjDnfXmmWof0W%2FZct3n4QEBwY